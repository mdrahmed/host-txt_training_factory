...
## Inside the ubuntu-18 dual boot
EXECUTEABLE_g++ =  clang++-14 -fno-discard-value-names -flegacy-pass-manager -g -Xclang -load -Xclang /home/raihan/LogPasses-new/FAVCIGVT\*/instrument.so -pthread
#EXECUTEABLE_g++ = clang++-14 -isystem /usr/include/c++/7.5.0 -isystem /usr/include/x86_64-linux-gnu/c++/7 -L /usr/include/x86_64-linux-gnu/c++/7 
# EXECUTEABLE_g+= = gcc
...
COMPILER_FLAGS_RELEASE = -std=gnu++0x -std=c++0x -I"TxtSmartFactoryLib/include" -I"TxtSmartFactoryLib/libs" -I"deps/include" -O3 -Wall -c -fmessage-length=0 -Wno-psabi
...
LINKER_FLAGS_RELEASE_PATHS = -L"TxtSmartFactoryLib/Posix_Release/src" -L"TxtSmartFactoryLib/Posix_Release"
...
LINKER_FLAGS_DEBUG_PATHS = -L"TxtSmartFactoryLib/Posix_Debug/src" -L"TxtSmartFactoryLib/Posix_Debug"

LINKER_FLAGS_LIBS = -l"crypto" -lpaho-mqtt3c -lpaho-mqtt3a -lpaho-mqttpp3 -lmosquitto -l"jsoncpp"
...
#	$(EXECUTEABLE_g++) -L"TxtSmartFactoryLib/Posix_Debug" -L"TxtSmartFactoryLib/Posix_Debug/libs" -L"deps/lib" -Wl,-rpath=/opt/knobloch/libs/ -o "$@.cloud"  TxtFactoryMain/Posix_Debug/src/main.o -lTxtSmartFactoryLib -lTxtControlLib -lSDLWidgetsLib -lMotorIOLib -lpaho-mqtt3c -lpaho-mqtt3a -lpaho-mqttpp3 -lopencv_core -lopencv_videoio -lopencv_imgcodecs -lopencv_imgproc -ljsoncpp -lalgobsec -lpthread -lSDL -lSDL_gfx -lSDL_ttf -lts -lfreetype -lz -lpng16 -lbz2 -ljpeg -lasound -lSDL_image -lnfc -lROBOProLib -lKeLibTxt
	$(EXECUTEABLE_g++) -L"TxtSmartFactoryLib/Posix_Debug" -L"TxtSmartFactoryLib/Posix_Debug/libs" -Wl,-rpath=/opt/knobloch/libs/ -o "$@.cloud"  TxtFactoryMain/Posix_Debug/src/main.o $(LINKER_FLAGS_LIBS)
...
# For HBW
# clang++-14 -fno-discard-value-names -flegacy-pass-manager -g -Xclang -load -Xclang /home/raihan/LogPasses-new/FAVCIGVT\*/instrument.so -pthread -std=gnu++0x -std=c++0x -I"TxtSmartFactoryLib/include" -I"TxtSmartFactoryLib/libs" -I"deps/include" -O3 -Wall -c -fmessage-length=0 -Wno-psabi -D"CLIENT_HBW" -fPIC -MMD -MP -MF"bin/TxtFactoryHBW" -MT"TxtFactoryClient/HBW_Release/src/main.d" -o "main.o" TxtFactoryClient/src/main.cpp
# main.o
#  clang++-14 -fno-discard-value-names -flegacy-pass-manager -g -Xclang -load -Xclang /home/raihan/LogPasses-new/FAVCIGVT\*/instrument.so -pthread
#  -std=gnu++0x -std=c++0x -I"TxtSmartFactoryLib/include" -I"TxtSmartFactoryLib/libs" -I"deps/include" -O3 -Wall -c -fmessage-length=0 -Wno-psabi
#  -D"CLIENT_HBW" -fPIC -MMD -MP -o "main.o" TxtFactoryClient/src/main.cpp

# HBW
# clang++-14 -fno-discard-value-names -flegacy-pass-manager -g -Xclang -load -Xclang /home/raihan/LogPasses-new/FAVCIGVT\*/instrument.so -pthread
# -Wl,-rpath=/opt/knobloch/libs/ TxtFactoryClient/HBW_Release/src/main.o 
# -L"TxtSmartFactoryLib/Posix_Release/src" -L"TxtSmartFactoryLib/Posix_Release"
#  -l"crypto" -lpaho-mqtt3c -lpaho-mqtt3a -lpaho-mqttpp3 -lmosquitto -l"jsoncpp" -o TxtFactoryHBW

# how Posix_Release is created
...
# 	$(EXECUTEABLE_g++) -L"TxtSmartFactoryLib/Posix_Release" -L"TxtSmartFactoryLib/Posix_Release/libs" -Wl,-rpath=/opt/knobloch/libs/ -o "$@.cloud" TxtFactoryMain/Posix_Release/src/main.o $(LINKER_FLAGS_LIBS)
